...
class TestConfigValidator:
    ...
    def test_config_validator_checks_required_files(
    ...
    def test_config_validator_result_has_required_attributes(
        self, temp_filesystem, full_config_setup
    ):
    ...
    def test_config_validator_validates_schema_content(
    ...
    def test_config_validator_passes_valid_schema_content(
        self, temp_filesystem, file_factory
    ):
