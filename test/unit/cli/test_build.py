...
class TestBuildCommand:
    ...
    @patch("cli.commands.build.organize")
    @patch("cli.commands.build.BuildOrchestrator")
    def test_build_runs_orchestrator_execution(
        self, mock_orchestrator_class, mock_organize
    ):
    ...
    @patch("cli.commands.build.organize")
    @patch("cli.commands.build.BuildOrchestrator")
    def test_build_fails_if_organize_fails(
        self, mock_orchestrator_class, mock_organize
    ):
    ...
    @patch("cli.commands.build.organize")
    @patch("cli.commands.build.BuildOrchestrator")
    def test_build_fails_if_orchestrator_fails(
        self, mock_orchestrator_class, mock_organize
    ):
    ...
    @patch("cli.commands.build.organize")
    @patch("cli.commands.build.BuildOrchestrator")
    def test_build_orchestrator_success_message(
        self, mock_orchestrator_class, mock_organize
    ):
    ...
    @patch("cli.commands.build.organize")
    @patch("cli.commands.build.BuildOrchestrator")
    def test_build_organize_cascade_result_handling(
        self, mock_orchestrator_class, mock_organize
    ):
    ...
    @patch("cli.commands.build.organize")
    @patch("cli.commands.build.BuildOrchestrator")
    def test_build_orchestrator_delegates_idempotency(
        self, mock_orchestrator_class, mock_organize
    ):
    ...
    @patch("cli.commands.build.organize")
    @patch("cli.commands.build.BuildOrchestrator")
    def test_build_orchestrator_handles_config_loading(
        self, mock_orchestrator_class, mock_organize
    ):
