...
class TestGalleriaCLIE2E:
    ...
    @pytest.mark.skip(reason="Plugin file writing issue - plugins report success but don't write files to disk")
    def test_cli_generate_command_with_fake_filesystem(self):
        ...
        with Patcher() as patcher:
            ...
            for i in range(3):
                ...
                # Create a fake JPEG with minimal header + some content
                fake_jpeg_data = b"\xFF\xD8\xFF\xE0" + b"\x00" * 1024  # JPEG header + 1KB data
                fs.create_file(photo_path, contents=fake_jpeg_data)
